...
const LoadingIndicator: React.FC<LoadingIndicatorProps> = ({ title, messages }) => {
    ...
    return (
        <div className="fixed inset-0 z-50 grid place-items-center bg-black/10 backdrop-blur-sm text-center animate-fade-in p-4">
            <div className="bg-white/20 backdrop-blur-2xl border border-white/20 rounded-3xl shadow-xl p-8 sm:p-12">
                <div className="relative w-24 h-24 mb-6 mx-auto">
                    <div className="absolute inset-0 border-4 border-teal-600 rounded-full animate-ping opacity-60"></div>
                ...
                <div className="h-6">
                    <p className="text-slate-500 text-lg transition-all duration-500 ease-in-out animate-fade-in" key={currentMessageIndex}>
